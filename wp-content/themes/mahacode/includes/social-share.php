...
function Radix_header_socials() { ?>
	...
	<ul class="unstyled">
		...
		<li>
			<a class="twitter" itemprop="url" title="twitter" href="<?php echo esc_url( $twitter ); ?>">
		...
		<li>
			<a class="facebook" itemprop="url" title="facebook" href="<?php echo esc_url( $facebook ); ?>">
		...
		<li>
			<a class="google" itemprop="url" title="google+" href="<?php echo esc_url( $google_plus ); ?>">
		...
		<li>
			<a class="pinterest" itemprop="url" title="pinterest" href="<?php echo esc_url( $pinterest ); ?>">
		...
		<li>
			<a class="dribbble" itemprop="url" title="dribbble" href="<?php echo esc_url( $dribbble ); ?>">
		...
		<li>
			<a class="linkedin" itemprop="url" title="linkedin" href="<?php echo esc_url( $linkedin ); ?>">
		...
		<li>
			<a class="flickr" itemprop="url" title="flickr" href="<?php echo esc_url( $flickr ); ?>">
		...
		<li>
			<a class="vimeo" itemprop="url" title="vimeo" href="<?php echo esc_url( $vimeo ); ?>">
		...
		<li>
			<a class="rss" itemprop="url" title="rss" href="<?php echo esc_url( $rss ); ?>">
...
<!--	<span class="screen-reader-text">--><?php //_e('Author Socials', 'radix'); ?><!--</span>-->
...
<!--		<li>-->
			<a class="ti-twitter" title="twitter" href="<?php echo esc_url( $twitter ); ?>">
<!--				<i class="fa fa-twitter" aria-hidden="true"></i><span class="screen-reader-text">Twitter</span>-->
			</a>
<!--		</li>-->
		<?php } ?>
...
<!--		<li>-->
			<a class="ti-facebook" title="facebook" href="<?php echo esc_url( $facebook ); ?>">
<!--				<i class="fa fa-facebook" aria-hidden="true"></i><span class="screen-reader-text">Facebook</span>-->
			</a>
<!--		</li>-->
		<?php } ?>
...
<!--		<li>-->
			<a class="ti-googleplus" title="google+" href="<?php echo esc_url( $google_plus ); ?>">
<!--				<i class="fa fa-google-plus" aria-hidden="true"></i><span class="screen-reader-text">Google+</span>-->
			</a>
<!--		</li>-->
		<?php } ?>
...
<!--		<li>-->
			<a class="ti-linkedin" title="linkedin" href="<?php echo esc_url( $linkedin ); ?>">
<!--				<i class="fa fa-linkedin" aria-hidden="true"></i><span class="screen-reader-text">Linkedin</span>-->
			</a>
<!--		</li>-->
		<?php } ?>
	...
	<nav id="footer-socials">
		<div class="social-bar">
			<div class="container-fluid clearfix">
				<div class="row-fluid">
					<span class="screen-reader-text"><?php _e('Footer Socials', 'radix'); ?></span>
