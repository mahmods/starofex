...
function Radix_footer_nav() {
  wp_nav_menu(array(
    'menu'              => __('القائمة في الفوتر', 'radix'),
...
function Radix_top_nav() {
    wp_nav_menu(array(
            'menu'              => __('القائمة العلوية', 'radix'),
            ...
            <ul id="dropdown_animation" class="dropdown-menu">
                <li>
                    <form class="navbar-form" role="search" action="'. esc_url( get_home_url( '/' ) ) . '">     
                        ...
                        <label for="nav-search" class="screen-reader-text">' . sprintf ( __('Search', 'radix') ) . '</label>
                            <input type="text" name="s" id="nav-search" class="search-pop form-control" value="" placeholder="' . sprintf (__('Search', 'radix') ) . '"/>
...
function Radix_widgets_init() {
  ...
  switch (ro_get_option('footer_col')) {
    ...
    register_sidebar(array(
     ...
     'before_widget' => '<div class="footer-widgets col-s-12 col-m-8 col-m-6 col-l-4 %2$s" id="%1$s">',
     'after_widget'  => '</div>',
     'before_title'  => '<h2 class="capitalize title-footer">',
     'after_title'   => '</h2>',
     ) );
    break;
    ...
    register_sidebar(array(
     ...
     'id'            => 'footer-widget-1',
     'description'   => __('The first Row of Footer Widgets, place widgets as per no. of footer widgets setting you set in Theme Options', 'radix'),
     'before_widget' => '<div class="footer-widgets col-s-12 col-m-8 col-l-3 %2$s" id="%1$s">',
     'after_widget'  => '</div>',
    'before_title'  => '<h2 class="capitalize title-footer">',
    'after_title'   => '</h2>',
     ) );
    ...
    register_sidebar(array(
     ...
     'id'            => 'footer-widget-1',
     'description'   => __('The first Row of Footer Widgets, place widgets as per no. of footer widgets setting you set in Theme Options', 'radix'),
     'before_widget' => '<div class="footer-widgets col-s-12 col-m-8 col-m-3 col-l-2 %2$s" id="%1$s">',
     'after_widget'  => '</div>',
    'before_title'  => '<h2 class="capitalize title-footer">',
    'after_title'   => '</h2>',
     ) );
    ...
    register_sidebar(array(
     'name'          => __( 'Footer Widget En', 'radix' ),
     'id'            => 'footer-widget-2',
     'description'   => __('The first Row of Footer Widgets, place widgets as per no. of footer widgets setting you set in Theme Options', 'radix'),
     'before_widget' => '<div class="footer-widgets %2$s" id="%1$s">',
     'after_widget'  => '</div>',
        'before_title'  => '<h2 class="capitalize title-footer">',
        'after_title'   => '<div class="title-star"><span class="ti-android-star"></span><span class="ti-android-star"></span><span class="ti-android-star"></span><span class="ti-android-star"></span><span class="ti-android-star"></span></div></h2>',
     ) );
